...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function() {
				$('#dg').datagrid({    
				    url:'${pageContext.request.contextPath}/clientType/getclienttypes',  
				    method:'get',
				    idField:'id',
				    pagination:true,
				    fitColumns:true,
				    ...
				    toolbar:[{
				    	text: '添加', iconCls: 'icon-add', handler: function () {	
							$('#outdl').dialog({
								href:'${pageContext.request.contextPath}/clientType/add',
								method:'get',
								title:'新增客户类型:',
								cache:false,
								width:400,    
								...
								buttons:[{
									...
									iconCls:'icon-save',
									handler:function(){
										$('#clientTypeform').form('submit',{
											url:'${pageContext.request.contextPath}/clientType/save',
											method:'post',
				    ...
				    columns:[[    
				              ...
				              {field:'typeName',title:'客户类型',rowspan:2,width:80,sortable:true},    
		...
		function dgedit(rowid){
				$('#outdl').dialog({
					href:'${pageContext.request.contextPath}/clientType/edit/'+rowid,
					method:'get',
					title:'修改客户类型:',
					cache:false,
					width:380,    
					...
					onLoad:function(){     //弹窗加载完成后执行
						$('#clientTypeform').form('load','${pageContext.request.contextPath}/clientType/getedit/'+rowid);
					}
				});
			}
			 ...
			 function dgdelete(rowid){  //删除操作  
		            ...
		            $.messager.confirm('确认','id='+rowid+'\r确认删除?',function(sure){  
		                if(sure){  
		                    ...
		                    $.ajax({  
		                    	cache:false,
		                        url:'${pageContext.request.contextPath}/clientType/delete/'+rowid,  
		                        method:'post',
		                        success:function(){
		                        	$.messager.show({
		                        	title:'提示',
	...
	<body>
		<div id="tdiv">
			...
			<div id="mm" style="width:120px"> 
				...
				<div data-options="name:'typeName',iconCls:'icon-ok'">按客户类型查询</div> 
			</div>
		</div>
		<div>
			<table id="dg"></table>  	
